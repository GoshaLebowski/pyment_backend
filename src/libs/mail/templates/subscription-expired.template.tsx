...
export function SubscriptionExpiredTemplate(
    { accountUrl }: SubscriptionExpiredTemplateProps
) {
    return (
        <Html>
            <Head>
                ...
                <Body className="bg-gray-50 font-sans text-gray-700">
                    <Container className="max-w-2xl mx-auto bg-white rounded-md shadow-md">
                        <div className="relative px-8 py-16 overflow-hidden">
                            <div
                                className="absolute inset-0 bg-gradient-radial from-red-100 via-red-50 to-transparent pointer-events-none" />
                            <div className="relative text-center">
                                <Heading className="mb-2 text-2xl font-bold text-slate-900">
                                    Подписка истекла
                                </Heading>
                                <Text className="text-base text-slate-500">
                                    Ваша подписка на сервис закончилась. Чтобы продолжить пользоваться всеми функциями,
                                    продлите её в личном кабинете.
                                </Text>
                            </div>
